...
<p>
    ...
    <select name="emailto" id="emailing-to">    
      ...
      <option value="ngf4@nau.edu">cg695@nau.edu</option>
      <option value="ngf4@nau.edu">harrison@nau.edu</option>
      <option value="ngf4@nau.edu">eld66@nau.edu</option>     
    </select>
    <br>
    <label>Subject:
...
mail($emailto, $subject, $emailbody);
